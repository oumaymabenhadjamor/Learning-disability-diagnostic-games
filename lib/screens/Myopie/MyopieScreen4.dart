...
class MyopieScreen4 extends StatefulWidget {
  const MyopieScreen4({Key key}) : super(key: key);

  @override
  _CountdownPageState createState() => _CountdownPageState();
}

class _CountdownPageState extends State<MyopieScreen4>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     ...
     deactived = false ;
                    ...
                    builder: (context, acceptedItems,rejectedItem) => Container(
                      ...
                      child: Text(item.name,style: TextStyle( fontSize: 80,color:item.coleur? Colors.orangeAccent:Colors.black)),
                    ),
     ...
     deactived = false ;
                    ...
                    builder: (context, acceptedItems,rejectedItem) => Container(
                      ...
                      child: Text(item.name,style: TextStyle( fontSize: 60,color:item.coleur? Colors.orangeAccent:Colors.black)),
                    ),
    ...
    deactived = false ;
                    ...
                    builder: (context, acceptedItems,rejectedItem) => Container(
                      ...
                      child: Text(item1.name,style: TextStyle( fontSize: 60,color:item1.coleur? Colors.orangeAccent:Colors.black)),
                    ),
          ...
          Padding(
            padding :const EdgeInsets.only(right:180.0, top:365.0),
            child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
     ...
     deactived = false;
          ...
          Padding(
            padding :const EdgeInsets.only(left:210.0, top:365.0),
            child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
     ...
     deactived = false ;
          ...
          Padding(
            padding :const EdgeInsets.only(left:80.0, top:365.0),
            child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
     ...
     deactived = false;
          ...
          Padding(
            padding :const EdgeInsets.only(right:50.0, top:365.0),
            child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
    ...
    if ( deactived == false ) {
          ...
          Padding(
            padding: const EdgeInsets.only(top:500,right: 165),
            child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
