...
import '../Daltonisme/DaltonismeScreen2.dart';

class DyslexieScreen51 extends StatefulWidget
{
...
class _AudioPlayerLocalAssetState extends State<DyslexieScreen51>  with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
      ...
      body: Stack(
        children: <Widget>[
          ...
          Padding(
            ...
            GestureDetector(
              onTap: (){
                audioPlayer.play('https://firebasestorage.googleapis.com/v0/b/login-demo-37c2c.appspot.com/o/audio14.mp3?alt=media&token=cc7c1c67-7ec2-44af-bbed-fc3e5cc08c8b');
    ...
    if ( deactived == false ) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DyslexieScreen52(),
