...
import 'package:diag/screens/Dyslexie/DyslexieScreen5.dart';
...
class DyslexieScreen53 extends StatefulWidget {
  const DyslexieScreen53({Key key}) : super(key: key);

  @override
  _CountdownPageState createState() => _CountdownPageState();
}

class _CountdownPageState extends State<DyslexieScreen53>
  ...
  initGame(){
    ...
    score=0;
    items=[
      ItemModel(name:"س", value:"Coffee"),
      ItemModel(name:"ض", value:"dog"),
      ItemModel(name:"ص", value:"Cat"),
...
print(DyslexieScore);
    ...
    return Scaffold(
      ...
      body:  Stack(
        children: [
          ...
          Transform.rotate(
            angle: 0.4,
            child: Padding(
              padding: const EdgeInsets.only(left:195.0,top:330),
              child: Container(
                decoration: BoxDecoration(
                  border: Border.all(
                ...
                width: 65.0,
                height: 65.0,
                child: Text(test==false ?"?":"", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.normal,color: Colors.indigo.shade900,fontSize: 45,),),
              ),
            ),
          ),
          Padding(
            padding: const EdgeInsets.only(left:188.0,top:335),
            child:
            Text("نور", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.normal,color: Colors.black45,fontSize: 55,),),
          )
          ,
          Padding(
            padding :const EdgeInsets.only(right:50.0, top:335.0),
            child: Row(
     ...
     deactived = false;
                    ...
                    builder: (context, acceptedItems,rejectedItem) => Container(
                      ...
                      child: Text(item.name,textAlign: TextAlign.center, style: TextStyle(color: item.coleur? Colors.indigo.shade900:Colors.transparent, fontSize:45,)),
                    ),
          ...
          Padding(
            padding: const EdgeInsets.only(left:95,top: 160),
            child:
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage("https://firebasestorage.googleapis.com/v0/b/login-demo-37c2c.appspot.com/o/mouette.png?alt=media&token=67c6e378-694a-4a31-8af7-fac97c725473"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
    ...
    if ( deactived == false ) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DyslexieScreen5(),
                    ...
                    child: Draggable<ItemModel>(
                      ...
                      childWhenDragging: Container(decoration: BoxDecoration(
                        ...
                        color: Colors.transparent,
                          ...
                          width: 75.0,
                          height: 75.0,child: Text(item.name, textAlign: TextAlign.center, style:TextStyle(fontFamily: 'Calibri',color: Colors.grey,fontWeight: FontWeight.w700,fontSize: 40.0,))),
                      ...
                      child: Container(  decoration: BoxDecoration(
                        ...
                        color: Colors.transparent,
                          ...
                          width: 75.0,
                          height: 75.0,child: Text( item.name ,textAlign: TextAlign.center,style: TextStyle(fontFamily: 'Calibri',color:Colors.black54, fontWeight: FontWeight.w700,fontSize: 40,))),
                    ),
                  );
