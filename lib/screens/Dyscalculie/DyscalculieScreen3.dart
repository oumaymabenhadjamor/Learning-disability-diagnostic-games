...
import 'package:diag/screens/Dyscalculie/DyscalculieScreen2.dart';
...
class DyscalculieScreen3 extends StatefulWidget {
  const DyscalculieScreen3({Key key}) : super(key: key);

  @override
  _CountdownPageState createState() => _CountdownPageState();
}

class _CountdownPageState extends State<DyscalculieScreen3>
  ...
  initGame(){
    ...
    score=0;
    items=[
      ItemModel(name:"12", value:"Coffee"),
      ItemModel(name:"10", value:"dog"),
      ItemModel(name:"11", value:"Cat"),
  ...
  Widget build(BuildContext context) {
      ...
      body:  Stack(
        children: [
          ...
          Transform.rotate(
            angle: 0.3,
            child: Padding(
              padding: const EdgeInsets.only(left:218.0,top: 170),
              child: Container(
                decoration: BoxDecoration(
                  border: Border.all(
          ...
          Padding(
            padding :const EdgeInsets.only(left:80.0, top:195.0),
            child: Row(
    ...
    deactived = false;
                    ...
                    builder: (context, acceptedItems,rejectedItem) => Container(
                      ...
                      child: Text(item.name, style: TextStyle(color: item.coleur? Colors.deepPurple:Colors.transparent, fontSize:40,)),
                    ),
    ...
    if ( deactived == false ) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DyscalculieScreen2(),
                    ...
                    feedback: Text(item.name,style: TextStyle(fontFamily: 'Calibri',color: Colors.grey, fontWeight: FontWeight.w700,fontSize: 40,)),
                      ...
                      child: Container(  decoration: BoxDecoration(
                        ...
                        color: Colors.transparent,
                          ...
                          width: 65.0,
                          height: 65.0,child: Text( item.name ,textAlign: TextAlign.center,style: TextStyle(fontFamily: 'Calibri',color:Colors.black54, fontWeight: FontWeight.w700,fontSize: 40,))),
                    ),
                  );
    ...
    color: Colors.transparent,
                ...
                child: Text(
                  ...
                  style: TextStyle(fontWeight: FontWeight.normal,color: Colors.blue,fontSize: 45),
                ),
              ),
            ),
          ),
          ...
          Transform.rotate(
            angle: 0.1,
            child: Padding(
              padding: const EdgeInsets.only(left:110.0,top: 200),
              child: Container(
                decoration: BoxDecoration(
                  border: Border.all(
                    color: Colors.orange,
                ...
                child: Text(
                  "9",
                  textAlign: TextAlign.center,
                  style: TextStyle(fontWeight: FontWeight.normal,color: Colors.orange,fontSize: 45,),
                ),
              ),
            ),
          ),
          Transform.rotate(
            angle: -0.2,
            child: Padding(
              padding: const EdgeInsets.only(left:260.0,top: 230),
              child: Container(
                decoration: BoxDecoration(
                  border: Border.all(
