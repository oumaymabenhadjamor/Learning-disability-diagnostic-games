...
import '../Daltonisme/DaltonismeScreen4.dart';

class DysphasieScreen2 extends StatefulWidget {
  const DysphasieScreen2({Key key}) : super(key: key);

  @override
  _CountdownPageState createState() => _CountdownPageState();
}

class _CountdownPageState extends State<DysphasieScreen2>
  ...
  initGame(){
    ...
    score=0;
    items=[
    ItemModel(name:"المدرسة", value:"table"),
    ItemModel(name:"إِلَى", value:"Coffee"),
    ItemModel(name:"التلاميذٍ", value:"dog"),
    ItemModel(name:"عاد", value:"Cat"),
    ItemModel(name:"و", value:"phone"),
    ItemModel(name:"العطلة", value: "Cake"),
    ItemModel(name:"انتهت", value:"bus"),
...
int MScore=0;
  ...
  Widget build(BuildContext context) {
    ...
    int DysphasieScore = ModalRoute.of(context).settings.arguments ;
    final user = Provider.of<UserProvider>(context);
    DysphasieScore=DysphasieScore+MScore;
    if(score==7){MScore=1;}else {MScore=0;}
        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              child:Image( image: NetworkImage("https://firebasestorage.googleapis.com/v0/b/login-demo-37c2c.appspot.com/o/image3.jpg?alt=media&token=bddc715d-d9fa-44b6-a9ec-bc9258beecb6"),
                fit: BoxFit.fill,
              ),
          ...
          GestureDetector(
            onTap: (){
              ...
              user.UpdateNiveau();
              testt.maladie="";
              testt.scoreDysphasie= DysphasieScore;
    ...
    if ( deactived == false ) {
          ...
          Padding(
            padding:const EdgeInsets.only(left:313.0, top:535.0),
          ...
          Padding(
            padding:const EdgeInsets.only(left:258.0, top:535.0),
            child:
            // Adobe XD layer: 'icons8-ligne-pointi…' (shape)
            Container(
              width: 40.0,
          ...
          Padding(
            padding:const EdgeInsets.only(left:210.0, top:535.0),
            child:
            // Adobe XD layer: 'icons8-ligne-pointi…' (shape)
            Container(
              width: 40.0,
          ...
          Padding(
            padding:const EdgeInsets.only(left:158.0, top:535.0),
            child:
            // Adobe XD layer: 'icons8-ligne-pointi…' (shape)
            Container(
              width: 40.0,
          ...
          Padding(
            padding:const EdgeInsets.only(left:112.0, top:535.0),
            child:
            // Adobe XD layer: 'icons8-ligne-pointi…' (shape)
            Container(
              width: 40.0,
          ...
          Padding(
            padding:const EdgeInsets.only(left:8.0, top:535.0),
            child:
            // Adobe XD layer: 'icons8-ligne-pointi…' (shape)
            Container(
              width: 40.0,
          ...
          Padding(
            padding:const EdgeInsets.only(left:60.0, top:535.0),
            child:
            // Adobe XD layer: 'icons8-ligne-pointi…' (shape)
            Container(
              width: 40.0,
          ...
          Padding(
            padding :const EdgeInsets.only(right:0.0, top:505.0),
            child: Row(
   ...
   deactived = false ;
                    ...
                    builder: (context, acceptedItems,rejectedItem) => Container(
                      ...
                      child: Text(item.name, style: TextStyle(color: item.coleur? Colors.black:Colors.transparent, fontSize:16,)),
                    ),
                ...
                children: items.map((item) {
                  return Container(
                    ...
                    child: Draggable<ItemModel>(
                      data: item,
                      childWhenDragging: Text(item.name, style: TextStyle(fontFamily: 'Calibri',color: Colors.black54,fontWeight: FontWeight.w700,fontSize: 18.0,)),
                      feedback: Text(item.name,style: TextStyle(fontFamily: 'Calibri',color: Colors.grey, fontWeight: FontWeight.w700,fontSize: 18,)),
                      child: Text( item.name ,style: TextStyle(fontFamily: 'Calibri',color: Colors.black54, fontWeight: FontWeight.w700,fontSize: 18,)),
                    ),
                  );
