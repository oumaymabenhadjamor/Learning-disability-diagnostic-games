...
class DyspraxieScreen2 extends StatefulWidget {
  const DyspraxieScreen2({Key key}) : super(key: key);

  @override
  _CountdownPageState createState() => _CountdownPageState();
}

class _CountdownPageState extends State<DyspraxieScreen2>
  ...
  Widget build(BuildContext context) {
    ...
    DyspraxieScore=DyspraxieScore+score;
    ...
    return Scaffold(
      ...
      body:  Stack(
        children: [
          ...
          Padding(
            padding:const EdgeInsets.only(left:118.0, top:515.0),
          ...
          Padding(
            padding: const EdgeInsets.only(left:168.0,top:495),
            child:
            Text("تقع النافورة على ", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.normal,color: Colors.black45,fontSize: 30,),),
          )
          ,
          Padding(
            padding :const EdgeInsets.only(right:75.0, top:485.0),
            child: Row(
     ...
     deactived = false ;
          ...
          Padding(
            padding: const EdgeInsets.only(left:38.0,top:495),
            child:
            Text(" الفتاة", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.normal,color: Colors.black45,fontSize: 30,),),
          )
          ,
          Padding(
            ...
            Container(
              ...
              child:Image( image:NetworkImage("https://firebasestorage.googleapis.com/v0/b/login-demo-37c2c.appspot.com/o/direction1.jpg?alt=media&token=f37a6c59-e0d5-45bc-aea2-ac556f47b82c"),
                fit: BoxFit.fill,
              ),
          ...
          GestureDetector(
            onTap: (){
              ...
              testt.scoreDyspraxie= DyspraxieScore;
                  ...
                  return Container(
                    ...
                    child: Draggable<ItemModel>(
                      ...
                      childWhenDragging: Container(
                          width: 60.0,
                          height: 60.0,child: Text(item.name, textAlign: TextAlign.center, style:TextStyle(fontFamily: 'Calibri',color: Colors.grey,fontWeight: FontWeight.w700,fontSize: 25.0,))),



                      feedback: Text(item.name,style: TextStyle(fontFamily: 'Calibri',color: Colors.grey, fontWeight: FontWeight.w700,fontSize: 25,)),
                      ...
                      child: Container(  decoration: BoxDecoration(
                        ...
                        color: Colors.transparent,
                          ...
                          width: 60.0,
                          height: 60.0,child: Text( item.name ,textAlign: TextAlign.center,style: TextStyle(fontFamily: 'Calibri',color:Colors.black54, fontWeight: FontWeight.w700,fontSize: 25,))),
                    ),
                  );
