...
import 'package:diag/screens/Daltonisme/DaltonismeScreen4.dart';
...
class DaltonismeScreen3 extends StatefulWidget
{
...
class _AudioPlayerLocalAssetState extends State<DaltonismeScreen3>  with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    if ( deactived == false ) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DaltonismeScreen8(),
    ...
    if ( deactived == false ) {
          ...
          Padding(
            padding: const EdgeInsets.only(left:255,top: 500),
            child: GestureDetector(
              onTap: (){
          ...
          Padding(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage("https://firebasestorage.googleapis.com/v0/b/login-demo-37c2c.appspot.com/o/image3.png?alt=media&token=419eb6a8-ceb6-48fd-ac07-b285bb87fd03"),
