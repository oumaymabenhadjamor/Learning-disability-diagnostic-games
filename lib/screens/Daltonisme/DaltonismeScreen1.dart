...
import 'package:diag/screens/Daltonisme/DaltonismeScreen6.dart';
...
import 'DaltonismeScreen2.dart';

class DaltonismeScreen1 extends StatefulWidget
{
...
class _AudioPlayerLocalAssetState extends State<DaltonismeScreen1>  with SingleTickerProviderStateMixin{
...
bool modified=false ;
  ...
  void initState() {
    super.initState();
    audioPlayer.play('https://firebasestorage.googleapis.com/v0/b/login-demo-37c2c.appspot.com/o/audio1.mp3?alt=media&token=f53b4216-b212-4910-ba69-c623234af564');
  ...
  Widget build(BuildContext context) {
    ...
    if ( deactived == false ) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DaltonismeScreen6(),
    ...
    fontWeight: FontWeight.w700,
          ...
          Padding(
            padding: const EdgeInsets.only(left:240,top: 505),
            child: GestureDetector(
              onTap: (){
          ...
          Padding(
            padding: const EdgeInsets.only(left:35,top: 505),
            child: GestureDetector(
              onTap: (){
            ...
            padding: const EdgeInsets.only(left:150,top: 505),
            child: GestureDetector(
              onTap: (){
          ...
          Padding(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage("https://firebasestorage.googleapis.com/v0/b/login-demo-37c2c.appspot.com/o/image2.jpg?alt=media&token=e82f2208-07f0-45c2-8a0e-fd61ec92f29a"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
