...
import '../../widget/color_options.dart';
import 'DaltonismeScreen2.dart';

class DaltonismeScreen8 extends StatefulWidget
{
...
class _AudioPlayerLocalAssetState extends State<DaltonismeScreen8> with SingleTickerProviderStateMixin {
  bool modified=false ;
  ...
  Widget build(BuildContext context) {
        ...
        body: Stack(
          children: <Widget>[
            ...
            Padding(
              ...
              child: ColorOptions(randomR, randomG, randomB, answerChooseHandler),
            ),
            Align(
    ...
    if ( deactived == false ) {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => DaltonismeScreen2(),
              ...
              onTap: (){
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    ...
                    settings: RouteSettings(
                      arguments:DaltonismeScore,
                      //ScreenArguments(DaltonismeScore,DyscalculieScore,DyslexieScore),
                    ),
                  ),
                ); }
              },
