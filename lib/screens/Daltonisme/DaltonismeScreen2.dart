...
import 'DaltonismeScreen3.dart';
import 'DaltonismeScreen4.dart';

class DaltonismeScreen2 extends StatefulWidget
{
...
class _AudioPlayerLocalAssetState extends State<DaltonismeScreen2>  with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    if ( deactived == false ) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DaltonismeScreen4(),
    ...
    if ( deactived == false ) {
          ...
          Padding(
            ...
            padding: const EdgeInsets.only(left:155,top: 500),
            child: GestureDetector(
              onTap: (){
          ...
          Padding(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage("https://firebasestorage.googleapis.com/v0/b/login-demo-37c2c.appspot.com/o/Baby.png?alt=media&token=6211bf0c-386e-47f1-9bd0-76bf9458b50b"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
